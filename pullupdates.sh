...
(cd EncryptFolder ; echo EncryptFolder ; git pull ; git fetch --tags )
(cd KeyBackup ; echo KeyBackup ; git pull ; git fetch --tags )
(cd CopyFiles ; echo CopyFiles ; git pull ; git fetch --tags )
